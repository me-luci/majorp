    ...
    <>
      ...
      >
        <div className="relative">
          <Link to={"/"}>
            <h4 className="text-2xl font-semibold mb-4">
              Bid<span className="text-[#0953ff]">Bazzar</span>
            </h4>
          </Link>
          ...
          {!isAuthenticated ? (
            <>
              <div className="my-4 flex gap-2">
                <Link
                  to={"/sign-up"}
                  className="bg-[#01ec19] font-semibold hover:bg-[#0357ff] text-xl py-1 px-4 rounded-md text-white"
                >
                  Sign Up
                </Link>
                <Link
            ...
            <>
              <div className="my-4 flex gap-4 w-fit" onClick={handleLogout}>
                <button className="bg-[#075bec] font-semibold hover:bg-[#b8381e] text-xl py-1 px-4 rounded-md text-white">
                  Logout
                </button>
              </div>
            </>
        ...
        <div>
          ...
          <p className="text-stone-500">&copy; BidBazzar, LLC.</p>
