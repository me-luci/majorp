    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem, magnam vero. Accusantium accusamus tempore ipsam architecto quasi aut repellat nulla doloremque, in minus, nesciunt perferendis beatae. Quas consequuntur quaerat libero?
          </p>
        </div>
        <div>
          <h3
